...
FILE_ID_LIST = []
FILE_NAME_LIST = []
EXT_PATH = "/Users/myeonghyeonjeong/Desktop/DATA_EXT/루플/_03_행동각도별_이미지_수집_엎드려자기(1849)/labeled_data_1849_"


SOURCE_PATH = "/Users/myeonghyeonjeong/Desktop/DATA_EXT/루플/_03_행동각도별_이미지_수집_엎드려자기(1849)/" + str(TASK_ID) + "/"
...
QUERY_prj_data = "SELECT result_json FROM TB_PRJ_DATA WHERE prj_idx =" + str(TASK_ID) + " AND prog_state_cd = 'ALL_FINISHED' AND check_edate > '2019-10-07 14:55:02'"
