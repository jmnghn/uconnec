...
EXT_PATH = "/Users/myeonghyeonjeong/Desktop/DATA_EXT/루플/01_행동_이미지_바운딩_핸드폰사용(1895)/"
EXT_PATH_LABELED = EXT_PATH + "labeled_data_1895_" + year + month + day + "/"
...
SOURCE_PATH = EXT_PATH + "source/1847/"
...
for q_1_data in QUERY_1_RESULT:
    ...
    print('data_dict: ', str(data_dict['data'][0]['id']))
    json_data_format['data_id'] = data_dict['data'][0]['id']
    ...
    for data in data_dict['data']:
        ...
        dots['x'] = min(data['dots'], key=lambda x: x['x'])['x']
        dots['y'] = min(data['dots'], key=lambda x: x['y'])['y']
        dots['width'] = abs(data['dots'][0]['x'] - data['dots'][1]['x'])
        dots['height'] = abs(data['dots'][1]['y'] - data['dots'][2]['y'])

        json_data_format["dots"].append(dots)
