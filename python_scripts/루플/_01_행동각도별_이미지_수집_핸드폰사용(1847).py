"""
[루플] 행동각도별 이미지 수집_#1 핸드폰 사용 (1847)
task_id: 3117
"""
...
FILE_ID_LIST = []
FILE_NAME_LIST = []
EXT_PATH = "/Users/myeonghyeonjeong/Desktop/DATA_EXT/루플/_01_행동각도별_이미지_수집_핸드폰사용(1847)/labeled_data_1847_"
SOURCE_PATH = "/Users/myeonghyeonjeong/Desktop/DATA_EXT/루플/_01_행동각도별_이미지_수집_핸드폰사용(1847)/" + str(
    TASK_ID) + "/"
...
QUERY_prj_data = "SELECT result_json FROM TB_PRJ_DATA WHERE prj_idx =" + str(
    TASK_ID) + " AND prog_state_cd = 'ALL_FINISHED' AND check_edate > '2019-10-07 14:47:54'"
