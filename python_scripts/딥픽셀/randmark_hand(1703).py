"""
[딥픽셀] 오른손 마디마디 찍어주시옵소서 (프로젝트아이디: 1703, 태스크아이디(10개): 2387,2388,2389,2390,2391,2392,2393,2394,2395,2396)
"""
...
EXT_PATH = "/Users/myeonghyeonjeong/Desktop/DATA_EXT/딥픽셀/오른손(1703)/labeled_data_1703_"
...
for data in RESULT:
    ...
    f = open(EXT_PATH + _fileName + '_H.pts', 'w', encoding='utf-8')

    for json_data in jsonData["right_hand"]["data"]:
